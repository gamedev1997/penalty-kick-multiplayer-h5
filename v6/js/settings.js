...
var NUM_SPRITE_GOALKEEPER = [   24, 42, 42, 51, 25, 34, 34, 
                                25, 30, 30, 30, 30,
                                51, 51, 36, 36
];
...
var ORIGIN_POINT_IMPACT_ANIMATION = [
    {x: null,    y: null  },   // IDLE           (0) – no shift
    {x: 295.74,  y: 3.76  },   // RIGHT          (1)
    {x: -324.82, y: 3.76  },   // LEFT           (2)
    {x: 4.8,     y: null  },   // CENTER_DOWN    (3) – vertical handled by sprite
    {x: 5,       y: null  },   // CENTER_UP      (4) – vertical handled by sprite
    {x: -354,    y: null  },   // LEFT_DOWN      (5)
    {x: 334.5,   y: null  },   // RIGHT_DOWN     (6) – vertical handled by sprite
    {x: 4.8,     y: null  },   // CENTER         (7) – vertical handled by sprite
    {x: -198.77, y: null  },   // SIDE_LEFT      (8) – vertical handled by sprite
    {x: 189,     y: null  },   // SIDE_RIGHT     (9) – vertical handled by sprite
    {x: -208.4,  y: null  },   // SIDE_LEFT_UP  (10) – vertical handled by sprite
    {x: 189,     y: null  },   // SIDE_RIGHT_UP (11) – vertical handled by sprite
    {x: -150,    y: null  },   // SIDE_LEFT_DOWN(12) – vertical handled by sprite
    {x: 101.8,   y: null  },   // SIDE_RIGHT_DOWN(13)– vertical handled by sprite
    {x: -344,    y: -88   },   // LEFT_UP       (14) – intentional upward leap: top-left corner
    {x: 315,     y: -88   }    // RIGHT_UP      (15) – intentional upward leap: top-right corner
]
...
var TIME_POLE_COLLISION_RESET = 2500;
...
var TIME_RESET_AFTER_SAVE = 900;  // ms — long enough to show ball rebound before reset

// 3D Y-depth where the virtual GK body intercepts the ball (must be < FIRST_AREA_GOAL_POS.y=131.1
// so the ball bounces back before crossing the goal-line sensor).
// GOAL_KEEPER_DEPTH_Y = 130; this is 4 units inside that, at the GK's standing position.
var GK_INTERCEPT_Y = 126;
...
// Goalkeeper State Machine Constants
var STATE_GK_IDLE = 0;
var STATE_GK_TRACKING = 1;
var STATE_GK_PREPARE = 2;
var STATE_GK_DIVE = 3;
var STATE_GK_SAVE_CONTACT = 4;
var STATE_GK_RECOVER = 5;