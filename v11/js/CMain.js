function CMain(oData) {
    ...
    this._loadImages = function () {
        ...
        s_oSpriteLibrary.addSprite("bannerLogo-1", "./sprites/banner/bannerLogo-1.png");
        s_oSpriteLibrary.addSprite("bannerLogo-2", "./sprites/banner/bannerLogo-2.png");
        s_oSpriteLibrary.addSprite("bannerLogo-3", "./sprites/banner/bannerLogo-3.png");
        ...
        for (var i = 1; i <= 26; i++) {
            ...
            s_oSpriteLibrary.addSprite("celebration_frame_" + i, "./sprites/Celebration/Argentina1/ezgif-frame-" + szNum + ".png");
        }
        */
    ...
    this.gotoMenu = function () {
        // Skip the main menu, go directly to mode select
        new CModeSelect(function (gameStartData) {
            s_oMain.gotoGame(gameStartData);
        });
        _iState = STATE_MENU;
    };

    this.gotoGame = function (gameStartData) {
        _oGame = new CGame(_oData, gameStartData);
        _iState = STATE_GAME;
    };
