                ...
                if(s_bMobile && ENABLE_CHECK_ORIENTATION){
                    if( iWidth>iHeight ){ 
                        if( $(".orientation-msg-container").attr("data-orientation") === "landscape" ){
                            ...
                            $(".orientation-msg-container").css("display","flex");
                            s_oMain.stopUpdate();
                        }  
                    }else{
...
function fullscreenHandler(){
    ...
    if (s_oInterface !== null && typeof s_oInterface.resetFullscreenBut === "function"){
        s_oInterface.resetFullscreenBut();
    }

    if (s_oMenu !== null && typeof s_oMenu.resetFullscreenBut === "function"){
